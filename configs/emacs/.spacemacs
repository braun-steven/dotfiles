...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(javascript
     ...
     ;; Edit textareas in firefox with emacs
     )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font (if (< (x-display-pixel-height) 2000)
                                 '("Hack"
                                   :size 17
                                   :weight normal
                                   :width normal)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq default-frame-alist '((font . "-SRC-Hack-normal-normal-normal-*-17-*-*-*-m-0-iso10646-1")))
  )
...
")
  ...
  ;; Enable xclip support for clipboard in -nw mode
  (xclip-mode t)
