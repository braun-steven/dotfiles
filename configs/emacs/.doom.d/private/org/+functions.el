...
(defun sbraun/org-clock-output-polybar ()
...
(defun sbraun/org-export-dispatch-repeat-last-action ()
  "Repeat the last org-export action."
  (interactive)
  (org-export-dispatch org-export-dispatch-last-action))

(defun sbraun/switch-to-agenda ()
  (interactive)
  (org-agenda nil "a")
  (delete-other-windows))

(defun sbraun/switch-to-agenda-phd ()
  (interactive)
  (org-agenda nil "cp")
  (delete-other-windows))

(defun sbraun/org-recent-done-items ()
...
;; 1) Set todo state
;; 2) Refile
(defun sbraun/org-agenda-process-inbox-item ()
